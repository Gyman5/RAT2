    ...
    platformStyle(_platformStyle)
{
    ...
    progressBar->setStyleSheet("QProgressBar { background-color: #8C8C8C; text-align: center; color: white; border: 1px solid #4b4b4b; } QProgressBar::chunk { background: #404040; margin: 0px; }");
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ratcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ratcoin: URIs)"));
...
//    connect(multisigAction, SIGNAL(triggered()), this, SLOT(gotoMultisigPage()));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ratcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ratcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a ratcoin: URI or payment request"));

    showHelpMessageAction = new QAction(QIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible ratcoin command-line options").arg(tr(PACKAGE_NAME)));

    openChatroomAction = new QAction(QIcon(":/icons/ratcoin"), tr("&Chatroom"), this);
    openChatroomAction->setStatusTip(tr("Open the ratcoin Discord in a web browser."));

    openForumAction = new QAction(QIcon(":/icons/ratcoin"), tr("&Forum"), this);
    openForumAction->setStatusTip(tr("Open https://talk.ratcoin.net in a web browser."));
...
void BitcoinGUI::openForum() {
    QDesktopServices::openUrl(QUrl("https://talk.ratcoin.net"));
}
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        tooltip = tr("%n active connection(s) to ratcoin network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
...
{
    QString strTitle = tr("ratcoin"); // default title
