...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed.ratcoin.net");
        vSeeds.emplace_back("seed2.ratcoin.net");
        vSeeds.emplace_back("seed.ratcoin-library.org");
        vSeeds.emplace_back("ppcseed.ns.7server.net");
        vSeeds.emplace_back("seed.ppcoin.info");

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,55);  // ratcoin: addresses begin with 'P'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,117); // ratcoin: addresses begin with 'p'
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("tseed.ratcoin.net");
        vSeeds.emplace_back("tseed2.ratcoin.net");
        vSeeds.emplace_back("tseed.ratcoin-library.org");
