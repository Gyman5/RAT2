...
const char * const BITCOIN_CONF_FILENAME = "ratcoin.conf";
const char * const BITCOIN_PID_FILENAME = "ratcoind.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/ratcoin";
#else
    // Unix
